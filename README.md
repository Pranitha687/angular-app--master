...
* Frontend - [**Angular 18.1.4**](https://github.com/angular/angular/releases) & [**Angular CLI 18.1.4**](https://github.com/angular/angular-cli/releases/)
...
> Dependencies
- [x] Angular : 18.1.4
- [x] Angular CLI : 18.1.4
- [x] Angular SSR : 18.1.4
- [x] Bootstrap : 5.3.3
- [x] Fontawesome : 6.6.0
...
- Etapes par étapes - https://www.ganatan.com/tutorials# angular-app--master
